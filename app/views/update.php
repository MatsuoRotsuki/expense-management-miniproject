...
<body class="bg-[#E5E5E5] w-full">
  ...
  <!-- Main container -->
  <form action="<?= "/expense-management-miniproject/update-expense/" . $data['expense_id'] ?>" method="post" onsubmit="">
    <div class="px-9 pt-6 pb-16 bg-white h-screen flex flex-col">
      <!-- <div class="float-left mt-16 bg-[#f9f9f9] rounded-full px-5 py-3 flex-none self-start">
        <a class="flex mx-auto" href="/expense-management-miniproject/dashboard">
      ...
      <div class="flex flex-row self-center items-center flex-1 justify-stretch">
        ...
        <div class="grid grid-cols-1 gap-6 text-xl ml-16 justify-item-stretch">
          ...
          <div class="flex flex-row justify-start rounded-full border-2 border-[#cdcdcd] px-4 py-2 bg-gray-100">
            ...
            <input type="text" name="description" placeholder="Description" class="bg-gray-100 mx-2" value="<?= $data['description'] ?>">
          </div>

          <div class="flex flex-row justify-start rounded-full border-2 border-[#cdcdcd] px-4 py-2 bg-gray-100">
            <img src="../public/icons/location.svg" width="30" height="30" alt="">
            <input type="text" name="location" placeholder="Location" class="bg-gray-100 mx-2" value="<?= $data['location'] ?>">
          </div>

          <div class="flex flex-row justify-start rounded-full border-2 border-[#cdcdcd] px-4 py-2 bg-gray-100">
            <img src="../public/icons/usd-circle.svg" width="30" height="30" alt="">
            <input type="text" name="amount" placeholder="Amount" class="bg-gray-100 mx-2" value="<?= $data['amount'] ?>">
          </div>
      ...
      <div class="self-end grid grid-cols-3 gap-8 flex-initial pr-5 font-bold">
        <button class="drop-shadow-xl" type="submit" name="update">
          <div class="bg-green-600 rounded-md px-4 py-3 text-white flex">
            <img src="../public/icons/update.svg" width="20" height="20">
            <span class="mx-5">Save</span>
          </div>
        </button>

        <a href="<?= "/expense-management-miniproject/expense/" . $data['expense_id'] ?>" class="drop-shadow-lg">
